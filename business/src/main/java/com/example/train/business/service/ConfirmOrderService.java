...
//            }
     ...
     * @param confirmOrder
     */
    private boolean sell(ConfirmOrder confirmOrder) {
...
//        }
        ...
        Integer startIndex = (int) dailyTrainTicket.getStartIndex();
        Integer endIndex = (int) dailyTrainTicket.getEndIndex();
        if(StrUtil.isNotBlank(ticketReq0.getSeat())) {
            ...
            getSeat(finalSeatList,
                    ...
                    ticketReq0.getSeat().substring(0, 1), // 从A1得到A
                    offsetList,
                    startIndex,
                    endIndex
            );
